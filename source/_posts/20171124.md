...
`Reactotron`由两部分组成，一部分是调试应用，一部分是调试配置。
  ...
  ```
  ![reactotron设置](./20171124/reactotron_01.png)
  ...
  ```
![reactotron设置](./20171124/reactotron_02.png)
![reactotron设置](./20171124/reactotron_03.png)
![reactotron结果](./20171124/reactotron_04.gif)
